...
const compress = async(req, res, next) => {
  ...
  if(inputMetadata.format.size > limit_size || inputMetadata.format_long_name.includes('jpeg') || inputMetadata.format_long_name.includes('jpg') || inputMetadata.format_long_name.includes('png')) {
